...
Public Class loadform
    ...
    Private Sub yearlydpusearch()
        ...
        Try ' try to open the db
            ...
            initdb()
            cbcarey = New SqlCommand("Select * From dbo.tblNorthBalt WHERE Date BETWEEN @StartDate AND @EndDate", connection)
            yeartbl.Clear()
    ...
    Public Sub search()
        ...
        If Selstring.Length > 0 Then
            ...
            SQL = "Select * From dbo.tblNorthBalt WHERE Date BETWEEN @StartDate AND @EndDate AND " & Selstring
        Else
            SQL = "Select * From dbo.tblNorthBalt WHERE Date BETWEEN @StartDate AND @EndDate"
        End If
    ...
    Private Sub cbford_CheckedChanged(sender As Object, e As EventArgs) Handles cbford.CheckedChanged
        clear()
        cartbl.Clear()
        temptbl.Clear()
        search()
