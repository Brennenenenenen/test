...
Public Class carjk2form
            ...
            For Each c As Control In gbDefects.Controls
                If c.GetType Is GetType(RadioButton) Then
                    ...
                    If c.Text = "" Then
                        ...
                        row("Enabled") = False
                        row("Location") = "Carey" 'lbllocation.Text
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs) Handles ToolStripButton3.Click
        ...
        Try
            ...
            cmd.CommandText = "INSERT INTO dbo.tblCarey (Date, Part, Serial_num, Coat, Rework, Adtech, Bacteria, Beveled_edge, Blister, Bond, Booth_Water, Chain_Debris,
